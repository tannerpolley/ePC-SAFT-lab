...
REGRESSION_TARGET_KIND_EVIDENCE: Final[tuple[dict[str, object], ...]] = (
    ...
    },
    {
        ...
        "production_scope": "registry only until implicit association-energy sensitivity and optimizer evidence land",
        "route_key": "association_parameter_pending",
    ...
    },
    {
        ...
        "optimizer_supported_target_kind": False,
        "public_production_supported_target_kind": False,
        "production_scope": "registry only until implicit association-volume sensitivity and optimizer evidence land",
        "route_key": "association_parameter_pending",
        "derivative_backend": "not_claimed",
        "optimizer_backend": "not_claimed",
        "tests": (),
    ...
    },
    {
        ...
        "optimizer_supported_target_kind": False,
        "public_production_supported_target_kind": False,
        "production_scope": "registry only for regression until l_ij optimizer evidence exists; active association remains excluded",
        "route_key": "binary_pair_pending",
        "derivative_backend": "not_claimed",
        "optimizer_backend": "not_claimed",
        "tests": (),
    ...
    },
    {
        ...
        "optimizer_supported_target_kind": False,
        "public_production_supported_target_kind": False,
        "production_scope": "registry only until binary association-parameter sensitivity and optimizer evidence land",
        "route_key": "binary_association_parameter_pending",
        "derivative_backend": "not_claimed",
        "optimizer_backend": "not_claimed",
        "tests": (),
        "revisit_after_issue": "#137",
