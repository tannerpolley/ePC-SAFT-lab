...
def table_results_path(filename: str) -> Path:
    path = TABLE_ROOT / "results" / filename
...
def main() -> None:
    ...
    common.write_rows(
        table_results_path("data/table_5_fugacity_comparison.csv"),
        [
            "quantity",
            "component",
            "phase",
    ...
    print(f"[write] {table_results_path('data/table_5_fugacity_comparison.csv')}")
