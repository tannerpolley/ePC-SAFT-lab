...
- Fig. 7: digitized paper AARD `15.1%`; current package AARD `100%`.
  ...
  PDF: `figures\figure_07\results\figure_7_package_vs_paper.pdf`
- Fig. 8: digitized paper AARD `17.9%`; current package AARD `56.3%`.
  ...
  PDF: `figures\figure_08\results\figure_8_package_vs_paper.pdf`
- Fig. 10: digitized paper AARD `9.2%`; current package AARD `100%`.
  ...
  SVG: `figures\figure_10\results\figure_10_package_vs_paper.svg`
  PDF: `figures\figure_10\results\figure_10_package_vs_paper.pdf`
- Fig. 11: digitized paper AARD `10.5%`; current package AARD `56.4%`.
  Data: `figures\figure_11\results\data\figure_11_package_vs_paper_points.csv`
  PNG: `figures\figure_11\results\figure_11_package_vs_paper.png`
  SVG: `figures\figure_11\results\figure_11_package_vs_paper.svg`
  PDF: `figures\figure_11\results\figure_11_package_vs_paper.pdf`
