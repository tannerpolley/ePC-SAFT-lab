...
REFERENCE_INPUTS = (
    ("ethanol-LiBr.csv", Path("data/reference/MIAC/ethanol/ethanol-LiBr.csv")),
    ("ethanol-NaBr.csv", Path("data/reference/MIAC/ethanol/ethanol-NaBr.csv")),
    ("methanol-LiCl.csv", Path("data/reference/MIAC/methanol/methanol-LiCl.csv")),
    ("methanol-NaBr.csv", Path("data/reference/MIAC/methanol/methanol-NaBr.csv")),
)
