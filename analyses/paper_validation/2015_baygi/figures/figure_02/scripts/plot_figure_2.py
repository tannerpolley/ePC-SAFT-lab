...
def main() -> None:
    ...
    diagnostics_path = common.output_path(OUTPUT).parent / "data" / "figure_2_diagnostics.csv"
    ...
    ax.set_title("Baygi 2015 Figure 2: pure MEA saturation")
    ...
    metrics_path = output_path.parent / "data" / "figure_2_metrics.csv"
    common.write_csv_rows(
        metrics_path,
