...
FIGURE_ID = "figure_09"
STEM = "gross_2002_figure_09_replication"
...
SOURCE_IMAGE = SOURCE_DIR / "paper_source_01_gross_2002_figure_009.png"
...
def _write_source_artifacts() -> list[dict[str, Any]]:
    ...
    metadata = {
        ...
        "provenance": {
            ...
            "digitization_basis": "manual calibrated digitization of the retained PC-SAFT solid curves in Figure 9",
            "curve_identity": {
...
def _score(source_rows: list[dict[str, Any]], model_rows: list[dict[str, Any]], native_receipt: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "score_basis": "temperature-coordinate RMSE against calibrated Gross 2002 Figure 9 retained PC-SAFT curve digitization using public pressure-route inversion",
...
def _write_plot(source_rows: list[dict[str, Any]], model_rows: list[dict[str, Any]], score_payload: dict[str, Any]) -> None:
    ...
    for series in SOURCE_SERIES:
        ...
        ax.scatter(
            ...
            linewidths=1.2,
            label=f"digitized paper {style['label']}",
            zorder=3,
        )
    ax.set_xlim(0.0, 1.0)
    ...
    SIDECAR.write_text(
        "\n".join(
            [
                ...
                "version: 1",
                "plot_id: gross_2002_figure_09_replication",
                "title: Gross 2002 Figure 9 PC-SAFT replication",
                "matplotlib:",
                "  title: Gross/Sadowski 2002 Figure 9 PC-SAFT replication",
                ...
                "render:",
                "  command: uv run --no-sync python analyses/paper_validation/2002_gross/figures/figure_09/scripts/generate_gross_2002_figure_09_replication.py",
                "",
            ]
        ),
        encoding="utf-8",
        ...
        record.update(
            {
                ...
                "source_data_basis": "calibrated Gross 2002 Figure 9 retained PC-SAFT solid-curve digitization with public pressure-route inversion over source-backed associating VLE pressure solves",
                "score": {
