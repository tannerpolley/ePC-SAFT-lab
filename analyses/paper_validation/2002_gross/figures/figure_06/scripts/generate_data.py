        ...
        epcsaft.ParameterSet.from_records(
            ...
            (
                ConstantInteractionRecord(
                    ...
                    pair,
                    0.015,
                    InteractionProvenance("literature", "Gross 2002 Table 2: 1-butanol-n-butane PC-SAFT row (k_ij=0.015)"),
                ),
            ),
...
def _score(source_rows: list[dict[str, Any]], model_rows: list[dict[str, Any]], native_receipt: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "score_basis": "pressure-coordinate RMSE against calibrated Gross 2002 Figure 6 retained P-x_Butane source points",
