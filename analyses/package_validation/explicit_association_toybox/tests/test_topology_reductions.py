...
def test_huang_radosz_2b_reduction_matches_closure_a_for_one_component_da_topology() -> None:
    density = 0.2
    strength = 3.0
    composition = np.array([1.0])
    ...
    assert result.derivation_relationship == "matches_closure_a_when_one_associating_component_da"
