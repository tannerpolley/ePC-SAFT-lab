...
HUANG_RADOSZ_TOPOLOGIES: dict[str, HuangRadoszTopology] = {
    "1": HuangRadoszTopology(
        ...
        derivation_relationship="topology_reduction_independent_of_exact_2b_reduction",
    ),
    ...
    "2B": HuangRadoszTopology(
        ...
        derivation_relationship="matches_exact_2b_reduction_when_one_associating_component_da",
    ),
