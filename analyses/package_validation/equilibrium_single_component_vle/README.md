...
- `results/` contains the generated route comparison table, plotted-data snapshot, and rendered SVG/PNG/PDF figures.
...
`data/reference/pure_component/saturation_properties/`. It records the live
`single_component_vle` route status for the 2B associating Held parameter
snapshots alongside the reusable source-property rows.
