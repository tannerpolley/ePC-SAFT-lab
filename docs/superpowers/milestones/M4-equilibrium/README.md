...
| [#261](../../issues/2026-06-15-m4-equilibrium-issue-0261-complete-generalized-phase-set-certification-gate.md) | `ready` | `Ipopt` | `blocked` | AFK child blocked by #260 for generalized phase-set certification with Stage II candidate-set replay and strict Stage III route refinement. |
