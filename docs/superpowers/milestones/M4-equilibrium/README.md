...
| [#188](../../issues/2026-05-30-m4-equilibrium-issue-0188-prove-source-backed-neutral-tp-flash-gfpe-fixture-after-held-gate.md) | `lle` | `Ipopt` | `ready` | Prove source-backed neutral TP-flash GFPE fixture after HELD gate. |
