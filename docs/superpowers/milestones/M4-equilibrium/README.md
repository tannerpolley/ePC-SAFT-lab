...
| [Issue #292 associating GFPE VLE admission prerequisite plan](../../plans/2026-06-20-m4-equilibrium-associating-vle-gfpe-admission-prerequisite-plan.md) | `association` | Opens the source-backed neutral associating binary VLE admission needed before #281 and #282 can generate Gross 2002 Figures 2-7 model curves. |
...
| --- | --- | --- | --- | --- |
| [#292](../../issues/2026-06-20-m4-equilibrium-issue-0292-open-associating-gfpe-vle-admission-for-gross-2002-binaries.md) | `association` | `Ipopt` | `ready` | Open the source-backed associating binary VLE admission path needed before #281 and #282 can generate model curves. |
