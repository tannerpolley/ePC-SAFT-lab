...
| [#241](../../issues/2026-06-11-m4-equilibrium-issue-0241-promote-neutral-held-1-0-stage-ii-to-replayable-dual-phase-discovery-gate.md) | `lle` | `Ipopt` | `ready` | Promote neutral HELD 1.0 Stage II to replayable dual phase-discovery gate. |
