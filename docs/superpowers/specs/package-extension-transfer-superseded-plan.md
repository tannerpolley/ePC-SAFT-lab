...
> `docs/superpowers/specs/monorepo-package-migration.md`. This document records the
...
is now `docs/superpowers/specs/monorepo-package-migration.md`.
...
`docs/superpowers/specs/monorepo-package-migration.md` for current gates and source
layout decisions.
