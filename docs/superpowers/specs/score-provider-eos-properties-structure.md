...
```json grill_plan_to_issue_handoff
{
  ...
  "plan_file": "docs/superpowers/specs/score-provider-eos-properties-structure.md",
  ...
  "doc_grill_evidence": {
    "docs_read": ["CONTEXT.md", "docs/agents/issue-tracker.md", "docs/superpowers/PROJECT_CONTEXT.md", "docs/superpowers/milestones/M3-eos/README.md", "docs/adr/0002-hard-public-api-reset-cppad-only-frontend.md", "docs/adr/0005-package-extension-split.md"],
