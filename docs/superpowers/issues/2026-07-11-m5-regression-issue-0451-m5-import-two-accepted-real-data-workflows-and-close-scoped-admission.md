---
issue: 451
title: "M5: import two accepted real-data workflows and close scoped admission"
url: https://github.com/ePC-SAFT/ePC-SAFT/issues/451
state: open
...
afk_hitl: HITL
branch: codex/issue-0451-m5-import-two-accepted-real-data-workflows-and-close-scoped-admission
last_synced: "2026-07-10"
---

# M5: import two accepted real-data workflows and close scoped admission

**GitHub Issue:** https://github.com/ePC-SAFT/ePC-SAFT/issues/451
...
**Intent:** Import only accepted methane/NIST and ethanol-water/Susial checker receipts, support freshness checking, and admit exactly those two local reproducible scopes.
...
Import only accepted methane/NIST and ethanol-water/Susial checker receipts, support freshness checking, and admit exactly those two local reproducible scopes.
