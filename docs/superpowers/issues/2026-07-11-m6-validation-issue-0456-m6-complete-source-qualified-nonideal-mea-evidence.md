---
issue: 456
title: "M6: complete source-qualified nonideal MEA evidence"
url: https://github.com/ePC-SAFT/ePC-SAFT/issues/456
state: open
...
source_spec: docs/superpowers/specs/2026-07-10-m4-nonideal-mea-speciation-linux-migration-design.md
source_plan: docs/superpowers/plans/2026-07-10-m6-standalone-ce-nonideal-input-evidence-plan.md
afk_hitl: HITL
branch: codex/issue-0456-m6-complete-source-qualified-nonideal-mea-evidence
last_synced: "2026-07-10"
---

# M6: complete source-qualified nonideal MEA evidence

**GitHub Issue:** https://github.com/ePC-SAFT/ePC-SAFT/issues/456
**GitHub Milestone:** M6 - Validation
**Issue Type:** Task
**Source Spec:** docs/superpowers/specs/2026-07-10-m4-nonideal-mea-speciation-linux-migration-design.md
**Source Plan:** docs/superpowers/plans/2026-07-10-m6-standalone-ce-nonideal-input-evidence-plan.md
...
**Outcome Source:** docs/superpowers/plans/2026-07-10-m6-standalone-ce-nonideal-input-evidence-plan.md#outcome-proof
**Intent:** Resolve or preserve every MEA input blocker, materialize typed source-qualified inputs only when complete, and retain Linux receipts, real literature/model tables, plots, and an evidence checker even when the model result is rejected.
...
Resolve or preserve every MEA input blocker, materialize typed source-qualified inputs only when complete, and retain Linux receipts, real literature/model tables, plots, and an evidence checker even when the model result is rejected.
