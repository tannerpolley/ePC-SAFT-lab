---
issue: 460
title: "M4 PE: admit neutral multiphase only after scoped phase-set discovery"
url: https://github.com/ePC-SAFT/ePC-SAFT/issues/460
state: open
milestone: "M4 - Equilibrium"
project: "ePC-SAFT Roadmap"
package: equilibrium
capability: neutral_multiphase
backend: Ipopt
...
afk_hitl: HITL
branch: codex/issue-0460-m4-pe-admit-neutral-multiphase-only-after-scoped-phase-set-discovery
last_synced: "2026-07-10"
---

# M4 PE: admit neutral multiphase only after scoped phase-set discovery

**GitHub Issue:** https://github.com/ePC-SAFT/ePC-SAFT/issues/460
...
**Plan Slice:** Task 4; later design must create source, discovery/refinement, evidence, and activation leaves.
...
**Intent:** Non-executable admission rollup requiring scoped complete discovery and result-owned postsolve certification; finite replay evidence remains internal and insufficient for public admission.
...
Non-executable admission rollup requiring scoped complete discovery and result-owned postsolve certification; finite replay evidence remains internal and insufficient for public admission.
