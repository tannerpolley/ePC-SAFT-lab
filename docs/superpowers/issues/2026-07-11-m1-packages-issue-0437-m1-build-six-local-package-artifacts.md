---
issue: 437
title: "M1: build six local package artifacts"
url: https://github.com/ePC-SAFT/ePC-SAFT/issues/437
state: open
...
afk_hitl: HITL
branch: codex/issue-0437-m1-build-six-local-package-artifacts
last_synced: "2026-07-10"
---

# M1: build six local package artifacts

**GitHub Issue:** https://github.com/ePC-SAFT/ePC-SAFT/issues/437
...
**Intent:** Build provider, equilibrium, and regression wheels/sdists from one clean commit through the installed-provider SDK boundary.
...
Build provider, equilibrium, and regression wheels/sdists from one clean commit through the installed-provider SDK boundary.

## Acceptance Criteria

- [ ] Deliver exactly `Task 2` within the `build` owner boundary.
...
- https://github.com/ePC-SAFT/ePC-SAFT/issues/436
