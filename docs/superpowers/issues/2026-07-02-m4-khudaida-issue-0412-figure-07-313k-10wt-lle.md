---
issue: 412
title: "M4 Khudaida Fig. 7: reproduce 313.15 K 10 wt% NaCl LLE with Figiel parameters"
url: "https://github.com/ePC-SAFT/ePC-SAFT/issues/412"
state: "open"
...
afk_hitl: "AFK"
branch: codex/issue-0412-khudaida-fig07
last_synced: "2026-07-02"
---

# M4 Khudaida Fig. 7: reproduce 313.15 K 10 wt% NaCl LLE with Figiel parameters

**GitHub Issue:** https://github.com/ePC-SAFT/ePC-SAFT/issues/412
...
**Goal Command:** /goal Resolve issue #412 and reproduce Khudaida Figure 7 with Figiel 2025 parameters.
**Execution Mode:** Auto after #411 closes
...
Reproduce `figure_07` at 313.15 K and 10 wt% NaCl from 24 source points, 6
paper ePC-SAFT points, and 6 feed rows. Current retained evidence accepts zero
model rows.
...
Regenerate Figure 7 artifacts and public-route electrolyte LLE diagnostics with
Figiel 2025 parameter provenance.

## Acceptance Criteria

- [ ] Figure 7 source/model CSVs and plot artifacts regenerate.
...
- No broad electrolyte capability claim beyond Figure 7 evidence.

## Proof Oracle

```powershell
uv run --no-sync python analyses\paper_validation\2026_khudaida\figures\figure_07\scripts\generate_data.py
uv run --no-sync python analyses\paper_validation\2026_khudaida\figures\figure_07\scripts\render_figure.py
uv run --no-sync python scripts\validation\check_khudaida_2026_figure_validation.py
uv run --no-sync python -m pytest packages\epcsaft-equilibrium\tests -k "khudaida and figure_07 and electrolyte" -q
