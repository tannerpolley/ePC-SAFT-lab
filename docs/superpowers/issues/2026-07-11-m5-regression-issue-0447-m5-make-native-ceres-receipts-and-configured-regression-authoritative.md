---
issue: 447
title: "M5: make native Ceres receipts and configured Regression authoritative"
url: https://github.com/ePC-SAFT/ePC-SAFT/issues/447
state: open
...
afk_hitl: HITL
branch: codex/issue-0447-m5-make-native-ceres-receipts-and-configured-regression-authoritative
last_synced: "2026-07-10"
---

# M5: make native Ceres receipts and configured Regression authoritative

**GitHub Issue:** https://github.com/ePC-SAFT/ePC-SAFT/issues/447
...
**Intent:** Make native controls, accepted termination, residual/objective scaling, and one configured Regression workflow authoritative through a deterministic receipt.
...
Make native controls, accepted termination, residual/objective scaling, and one configured Regression workflow authoritative through a deterministic receipt.

## Acceptance Criteria

- [ ] Deliver exactly `Tasks 3-4` within the `regression` owner boundary.
...
- https://github.com/ePC-SAFT/ePC-SAFT/issues/446
