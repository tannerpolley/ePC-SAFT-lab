---
issue: 453
title: "M6: retain methane/NIST configured fit evidence"
url: https://github.com/ePC-SAFT/ePC-SAFT/issues/453
state: open
...
afk_hitl: HITL
branch: codex/issue-0453-m6-retain-methane-nist-configured-fit-evidence
last_synced: "2026-07-10"
---

# M6: retain methane/NIST configured fit evidence

**GitHub Issue:** https://github.com/ePC-SAFT/ePC-SAFT/issues/453
...
**Intent:** Fit the exact four-temperature NIST methane objective, retain all nine independent prediction rows and literature/model plots, and publish a strict accepted receipt without target leakage.
...
Fit the exact four-temperature NIST methane objective, retain all nine independent prediction rows and literature/model plots, and publish a strict accepted receipt without target leakage.

## Acceptance Criteria

- [ ] Deliver exactly `Task 2` within the `benchmark` owner boundary.
