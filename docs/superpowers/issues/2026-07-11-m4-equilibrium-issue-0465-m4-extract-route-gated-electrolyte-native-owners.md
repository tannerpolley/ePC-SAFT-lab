---
issue: 465
title: "M4: extract route-gated electrolyte native owners"
url: https://github.com/ePC-SAFT/ePC-SAFT/issues/465
state: open
...
afk_hitl: HITL
branch: codex/issue-0465-m4-extract-route-gated-electrolyte-native-owners
last_synced: "2026-07-10"
---

# M4: extract route-gated electrolyte native owners

**GitHub Issue:** https://github.com/ePC-SAFT/ePC-SAFT/issues/465
...
**AFK/HITL:** HITL
**Classification:** HITL
**Labels:** native, validation, equilibrium, area:equilibrium, backend:ipopt, type:task, status:blocked
...
**Intent:** Move electrolyte discovery/refinement, route mechanics, and result-owned postsolve certification only after the exact charge-neutral correctness/caller gates pass.
...
Move electrolyte discovery/refinement, route mechanics, and result-owned postsolve certification only after the exact charge-neutral correctness/caller gates pass.

## Acceptance Criteria

- [ ] Deliver exactly `Task 7` within the `equilibrium` owner boundary.
