...
# M6 Khudaida Fig. S2: reproduce 5 wt% NaCl supporting LLE panels with Figiel parameters
...
- No broad electrolyte capability claim beyond retained Figure S2 evidence.
...
uv run --no-sync python -m pytest packages/epcsaft-equilibrium/tests -k "khudaida and figure_11 and electrolyte" -q
