---
issue: 414
title: "M6 Khudaida Fig. 9: reproduce ethanol distribution coefficient with Figiel parameters"
...
# M6 Khudaida Fig. 9: reproduce ethanol distribution coefficient with Figiel parameters
...
- No broad electrolyte capability claim beyond retained Figure 9 evidence.
...
uv run --no-sync python -m pytest packages/epcsaft-equilibrium/tests -k "khudaida and figure_09 and electrolyte" -q
