---
issue: 464
title: "M4: extract public-green equilibrium owners without behavior drift"
url: https://github.com/ePC-SAFT/ePC-SAFT/issues/464
state: open
...
afk_hitl: HITL
branch: codex/issue-0464-m4-extract-public-green-equilibrium-owners-without-behavior-drift
last_synced: "2026-07-10"
---

# M4: extract public-green equilibrium owners without behavior drift

**GitHub Issue:** https://github.com/ePC-SAFT/ePC-SAFT/issues/464
...
**Intent:** Move public-route result conversion, binding registration, neutral discovery, bubble/dew mechanics, and Python selector adaptation into canonical owners with exact before/after characterization.
...
Move public-route result conversion, binding registration, neutral discovery, bubble/dew mechanics, and Python selector adaptation into canonical owners with exact before/after characterization.

## Acceptance Criteria

- [ ] Deliver exactly `Tasks 2-6` within the `equilibrium` owner boundary.
