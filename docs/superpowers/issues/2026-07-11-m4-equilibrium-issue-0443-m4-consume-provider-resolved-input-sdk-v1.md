---
issue: 443
title: "M4: consume provider resolved-input SDK v1"
url: https://github.com/ePC-SAFT/ePC-SAFT/issues/443
state: open
...
source_plan: docs/superpowers/plans/2026-07-10-m4-equilibrium-provider-resolved-input-sdk-v1-consumer-plan.md
afk_hitl: HITL
branch: codex/issue-0443-m4-consume-provider-resolved-input-sdk-v1
last_synced: "2026-07-10"
---

# M4: consume provider resolved-input SDK v1

**GitHub Issue:** https://github.com/ePC-SAFT/ePC-SAFT/issues/443
**GitHub Milestone:** M4 - Equilibrium
**Issue Type:** Task
**Source Spec:** docs/superpowers/specs/2026-07-10-m3-eos-versioned-state-resolved-model-input.md
**Source Plan:** docs/superpowers/plans/2026-07-10-m4-equilibrium-provider-resolved-input-sdk-v1-consumer-plan.md
**Plan Slice:** Tasks 1-3
**Package Owner:** `equilibrium`
**AFK/HITL:** HITL
**Classification:** HITL
**Labels:** native, python-api, validation, equilibrium, area:equilibrium, backend:ipopt, type:task, status:blocked
...
**Outcome Source:** docs/superpowers/plans/2026-07-10-m4-equilibrium-provider-resolved-input-sdk-v1-consumer-plan.md#outcome-proof
**Intent:** Cut equilibrium construction and native calls to the provider-owned resolved-input SDK without duplicating provider serializers or broadening public routes.
...
Cut equilibrium construction and native calls to the provider-owned resolved-input SDK without duplicating provider serializers or broadening public routes.
