...
**Target Output:** The Khudaida checker reports complete artifacts, complete model reproduction, zero blockers, and every modeled figure or panel score at least `8.0`.
...
**Interface:** Public `Equilibrium(..., route="electrolyte_lle")`, retained paper-validation scripts, figure fit-statistics CSVs, and pytest scenario contracts.
...
**Acceptance Proof:** The proof oracle commands pass from the repo root and #191 names #320 as closed provenance after merge.
**Stop Criteria:** Stop if source inputs, parameter provenance, species basis, charge balance, solver seeds, or plotted data cannot be verified against retained inputs before changing solver logic.
...
and reduced-coordinate scenarios.
