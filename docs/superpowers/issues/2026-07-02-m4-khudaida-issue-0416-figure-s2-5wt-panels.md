---
issue: 416
title: "M4 Khudaida Fig. S2: reproduce 5 wt% NaCl supporting LLE panels with Figiel parameters"
...
# M4 Khudaida Fig. S2: reproduce 5 wt% NaCl supporting LLE panels with Figiel parameters

**GitHub Issue:** https://github.com/ePC-SAFT/ePC-SAFT/issues/416
...
**Execution Mode:** Auto after #415 closes
...
Reproduce `figure_11`, supporting Figure S2, for 5 wt% NaCl panels at 293.15,
303.15, and 313.15 K from 92 source points.
...
Regenerate Figure S2 panel artifacts and public-route electrolyte LLE
diagnostics with Figiel 2025 parameter provenance.

## Acceptance Criteria

- [ ] Figure S2 source/model CSVs and plot artifacts regenerate for all panels.
...
- No broad electrolyte capability claim beyond Figure S2 evidence.

## Proof Oracle

```powershell
uv run --no-sync python analyses\paper_validation\2026_khudaida\figures\figure_11\scripts\generate_data.py
