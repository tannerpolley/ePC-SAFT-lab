---
issue: 467
title: "M6: close combined regression real-data evidence gate"
url: https://github.com/ePC-SAFT/ePC-SAFT/issues/467
state: open
...
afk_hitl: HITL
branch: codex/issue-0467-m6-close-combined-regression-real-data-evidence-gate
last_synced: "2026-07-10"
---

# M6: close combined regression real-data evidence gate

**GitHub Issue:** https://github.com/ePC-SAFT/ePC-SAFT/issues/467
...
**Intent:** Validate both accepted lane receipts together, publish the combined M6 checker receipt, and hand exact immutable evidence identities to the final M5 importer.
...
Validate both accepted lane receipts together, publish the combined M6 checker receipt, and hand exact immutable evidence identities to the final M5 importer.

## Acceptance Criteria

- [ ] Deliver exactly `Task 4` within the `benchmark` owner boundary.
...
- https://github.com/ePC-SAFT/ePC-SAFT/issues/453
- https://github.com/ePC-SAFT/ePC-SAFT/issues/454
