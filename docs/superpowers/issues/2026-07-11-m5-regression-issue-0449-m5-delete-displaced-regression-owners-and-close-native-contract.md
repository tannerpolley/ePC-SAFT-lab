---
issue: 449
title: "M5: delete displaced regression owners and close native contract"
url: https://github.com/ePC-SAFT/ePC-SAFT/issues/449
state: open
...
afk_hitl: HITL
branch: codex/issue-0449-m5-delete-displaced-regression-owners-and-close-native-contract
last_synced: "2026-07-10"
---

# M5: delete displaced regression owners and close native contract

**GitHub Issue:** https://github.com/ePC-SAFT/ePC-SAFT/issues/449
...
**AFK/HITL:** HITL
**Classification:** HITL
**Labels:** native, regression, docs, validation, area:regression, backend:ceres, type:task, status:blocked
...
**Intent:** Delete parallel regression compilers/serializers and close the focused M5 native contract only after the configured workflow, persistence, and provider integration are complete.
...
Delete parallel regression compilers/serializers and close the focused M5 native contract only after the configured workflow, persistence, and provider integration are complete.

## Acceptance Criteria

- [ ] Deliver exactly `Task 6` within the `regression` owner boundary.
...
- https://github.com/ePC-SAFT/ePC-SAFT/issues/448
