---
issue: 322
title: "M4 CE: write CE/CPE boundary doctrine and registry update"
url: https://github.com/ePC-SAFT/ePC-SAFT/issues/322
state: closed
...
**Intent:** Make CE and CPE registry/docs boundaries explicit and enforce them with registry tests.
**Target Output:** Registry/docs tests prove CE is homogeneous and CPE remains blocked by CE and PE gates.
...
**Acceptance Proof:** Registry/docs tests prove CE is homogeneous and CPE remains blocked by CE and PE gates.
...
Make CE and CPE registry/docs boundaries explicit and enforce them with registry tests.
...
- https://github.com/ePC-SAFT/ePC-SAFT/issues/321
