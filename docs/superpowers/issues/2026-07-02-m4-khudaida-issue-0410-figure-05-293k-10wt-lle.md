---
issue: 410
title: "M4 Khudaida Fig. 5: reproduce 293.15 K 10 wt% NaCl LLE with Figiel parameters"
url: "https://github.com/ePC-SAFT/ePC-SAFT/issues/410"
state: "open"
...
afk_hitl: "AFK"
branch: codex/issue-0410-khudaida-fig05
last_synced: "2026-07-02"
---

# M4 Khudaida Fig. 5: reproduce 293.15 K 10 wt% NaCl LLE with Figiel parameters

**GitHub Issue:** https://github.com/ePC-SAFT/ePC-SAFT/issues/410
...
**Goal Command:** /goal Resolve issue #410 and reproduce Khudaida Figure 5 with Figiel 2025 parameters.
**Execution Mode:** Auto after #409 closes
...
Reproduce `figure_05` at 293.15 K and 10 wt% NaCl from 20 source points, 5
...
Regenerate Figure 5 artifacts and public-route electrolyte LLE diagnostics with
Figiel 2025 parameter provenance.

## Acceptance Criteria

- [ ] Figure 5 source/model CSVs and plot artifacts regenerate.
...
- No broad electrolyte capability claim beyond Figure 5 evidence.

## Proof Oracle

```powershell
uv run --no-sync python analyses\paper_validation\2026_khudaida\figures\figure_05\scripts\generate_data.py
uv run --no-sync python analyses\paper_validation\2026_khudaida\figures\figure_05\scripts\render_figure.py
uv run --no-sync python scripts\validation\check_khudaida_2026_figure_validation.py
uv run --no-sync python -m pytest packages\epcsaft-equilibrium\tests -k "khudaida and figure_05 and electrolyte" -q
