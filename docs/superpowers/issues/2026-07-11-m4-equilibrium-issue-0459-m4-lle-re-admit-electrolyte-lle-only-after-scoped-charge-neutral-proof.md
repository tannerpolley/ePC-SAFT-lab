---
issue: 459
title: "M4 LLE: re-admit electrolyte LLE only after scoped charge-neutral proof"
url: https://github.com/ePC-SAFT/ePC-SAFT/issues/459
state: open
...
afk_hitl: HITL
branch: codex/issue-0459-m4-lle-re-admit-electrolyte-lle-only-after-scoped-charge-neutral-proof
last_synced: "2026-07-10"
---

# M4 LLE: re-admit electrolyte LLE only after scoped charge-neutral proof

**GitHub Issue:** https://github.com/ePC-SAFT/ePC-SAFT/issues/459
...
**Plan Slice:** Task 3; later design must create source, route, evidence, and activation leaves.
...
**Intent:** Non-executable admission rollup requiring source-qualified reduced-electroneutral discovery, refinement, postsolve evidence, and a separate selector activation decision.
...
Non-executable admission rollup requiring source-qualified reduced-electroneutral discovery, refinement, postsolve evidence, and a separate selector activation decision.
