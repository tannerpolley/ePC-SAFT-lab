---
issue: 409
title: "M4 Khudaida Fig. 4: reproduce 313.15 K 5 wt% NaCl LLE with Figiel parameters"
url: "https://github.com/ePC-SAFT/ePC-SAFT/issues/409"
state: "open"
...
afk_hitl: "AFK"
branch: codex/issue-0409-khudaida-fig04
last_synced: "2026-07-02"
---

# M4 Khudaida Fig. 4: reproduce 313.15 K 5 wt% NaCl LLE with Figiel parameters

**GitHub Issue:** https://github.com/ePC-SAFT/ePC-SAFT/issues/409
...
**Goal Command:** /goal Resolve issue #409 and reproduce Khudaida Figure 4 with Figiel 2025 parameters.
**Execution Mode:** Auto after #408 closes
...
Reproduce `figure_04` at 313.15 K and 5 wt% NaCl from 28 source points, 7 paper
ePC-SAFT points, and 7 feed rows. Current retained evidence accepts 6 model
rows and must close the missing-row gap.
...
Regenerate Figure 4 artifacts and public-route electrolyte LLE diagnostics with
Figiel 2025 parameter provenance.

## Acceptance Criteria

- [ ] Figure 4 source/model CSVs and plot artifacts regenerate.
...
- No broad electrolyte capability claim beyond Figure 4 evidence.

## Proof Oracle

```powershell
uv run --no-sync python analyses\paper_validation\2026_khudaida\figures\figure_04\scripts\generate_data.py
uv run --no-sync python analyses\paper_validation\2026_khudaida\figures\figure_04\scripts\render_figure.py
uv run --no-sync python scripts\validation\check_khudaida_2026_figure_validation.py
uv run --no-sync python -m pytest packages\epcsaft-equilibrium\tests -k "khudaida and figure_04 and electrolyte" -q
