---
issue: 408
title: "M4 Khudaida Fig. 3: reproduce 303.15 K 5 wt% NaCl LLE with Figiel parameters"
url: "https://github.com/ePC-SAFT/ePC-SAFT/issues/408"
state: "open"
...
afk_hitl: "AFK"
branch: codex/issue-0408-khudaida-fig03
last_synced: "2026-07-02"
---

# M4 Khudaida Fig. 3: reproduce 303.15 K 5 wt% NaCl LLE with Figiel parameters

**GitHub Issue:** https://github.com/ePC-SAFT/ePC-SAFT/issues/408
...
**Execution Mode:** Auto after #407 closes
...
Reproduce `figure_03` at 303.15 K and 5 wt% NaCl from 32 source points, 8 paper
ePC-SAFT points, and 8 feed rows. Current retained evidence accepts zero model
rows.
...
Regenerate Figure 3 artifacts and public-route electrolyte LLE diagnostics with
Figiel 2025 parameter provenance.

## Acceptance Criteria

- [ ] Figure 3 source/model CSVs and plot artifacts regenerate.
...
- No broad electrolyte capability claim beyond Figure 3 evidence.

## Proof Oracle

```powershell
uv run --no-sync python analyses\paper_validation\2026_khudaida\figures\figure_03\scripts\generate_data.py
uv run --no-sync python analyses\paper_validation\2026_khudaida\figures\figure_03\scripts\render_figure.py
uv run --no-sync python scripts\validation\check_khudaida_2026_figure_validation.py
uv run --no-sync python -m pytest packages\epcsaft-equilibrium\tests -k "khudaida and figure_03 and electrolyte" -q
