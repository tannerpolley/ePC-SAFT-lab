---
issue: 458
title: "M4 LLE: re-admit neutral LLE only after scoped phase-discovery proof"
url: https://github.com/ePC-SAFT/ePC-SAFT/issues/458
state: open
milestone: "M4 - Equilibrium"
project: "ePC-SAFT Roadmap"
package: equilibrium
capability: neutral_lle
backend: Ipopt
...
afk_hitl: HITL
branch: codex/issue-0458-m4-lle-re-admit-neutral-lle-only-after-scoped-phase-discovery-proof
last_synced: "2026-07-10"
---

# M4 LLE: re-admit neutral LLE only after scoped phase-discovery proof

**GitHub Issue:** https://github.com/ePC-SAFT/ePC-SAFT/issues/458
...
**Plan Slice:** Task 2; later design must create source, route, evidence, and activation leaves.
...
**Executable:** false
**Parent:** https://github.com/ePC-SAFT/ePC-SAFT/issues/363
...
**Intent:** Non-executable admission rollup requiring globally adequate scoped discovery and exact postsolve evidence; finite sampled candidates cannot establish global phase-set completeness.
...
Non-executable admission rollup requiring globally adequate scoped discovery and exact postsolve evidence; finite sampled candidates cannot establish global phase-set completeness.
