...
- Implementation owner: packages/epcsaft-equilibrium/src/epcsaft_equilibrium/native/equilibrium/core/two_phase_eos_route.cpp; packages/epcsaft-equilibrium/src/epcsaft_equilibrium/native/equilibrium/core/two_phase_eos_route.h; docs/milestones/M4-equilibrium/ideas/generalized-fluid-phase-equilibrium.md
...
- Implementation owner: packages/epcsaft-equilibrium/src/epcsaft_equilibrium/native/equilibrium/core/two_phase_eos_route.cpp; packages/epcsaft-equilibrium/src/epcsaft_equilibrium/native/equilibrium/core/activation_matrix.h; docs/milestones/M4-equilibrium/ideas/generalized-fluid-phase-equilibrium.md
- Validation: packages/epcsaft-equilibrium/tests/native/results/test_neutral_vle_reference_values.py; packages/epcsaft-equilibrium/tests/native/results/test_neutral_lle_reference_values.py; packages/epcsaft-equilibrium/tests/native/diagnostics/test_selector_core_contracts.py
...
- Implementation owner: packages/epcsaft-equilibrium/src/epcsaft_equilibrium/native/equilibrium/core/two_phase_eos_route.cpp; docs/milestones/M4-equilibrium/ideas/generalized-fluid-phase-equilibrium.md
...
- Implementation owner: packages/epcsaft-equilibrium/src/epcsaft_equilibrium/native/equilibrium/core/two_phase_eos_route.cpp; packages/epcsaft-equilibrium/src/epcsaft_equilibrium/native/equilibrium/register_bindings.cpp; docs/milestones/M4-equilibrium/ideas/generalized-fluid-phase-equilibrium.md
- Validation: packages/epcsaft-equilibrium/tests/native/results/test_neutral_vle_reference_values.py; packages/epcsaft-equilibrium/tests/native/results/test_neutral_lle_reference_values.py; packages/epcsaft-equilibrium/tests/native/diagnostics/test_selector_core_contracts.py
...
- Implementation owner: docs/milestones/M4-equilibrium/ideas/generalized-fluid-phase-equilibrium.md; docs/milestones/M4-equilibrium/registries/equilibrium-benchmark-registry.yaml
...
- Implementation owner: docs/milestones/M3-eos/ideas/explicit-association-closure-for-pcsaft.md; docs/derivation/explicit_association_closure_for_pcsaft.tex
