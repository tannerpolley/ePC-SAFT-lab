...
| Goal 4 | #136, #135 update | Open as of 2026-05-22 verification | Implemented locally on `codex/association-goals-4-6`; review until merged | Review pure association parameter derivative evidence and capability-scope update. | IntelliJ `Association Goal 4 Tests` passed locally; issue #136 has a validation comment. |
| Goal 5 | #137, #135 update | Open as of 2026-05-22 verification | Implemented locally on `codex/association-goals-4-6`; review until merged | Review binary association parameter derivative evidence and capability-scope update. | IntelliJ `Association Goal 5 Tests` passed locally; issue #137 has a validation comment. |
| Goal 6 | #138, #139 | Open as of 2026-05-22 verification | Implemented locally on `codex/association-goals-4-6`; review until merged | Review ADR 0004 and lifted fixed-delta association block readiness evidence. | IntelliJ `Association Goal 6 Tests` passed locally; docs validation should be included before handoff. |
